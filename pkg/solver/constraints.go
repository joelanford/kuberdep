...
//type all []Constraint
//
//func (constraint all) String(subject Identifier) string {
//	s := make([]string, len(constraint))
//	for i, each := range constraint {
//		s[i] = each.String(subject)
//	}
//	return fmt.Sprintf("%s requires all of [%s]", subject, strings.Join(s, ", "))
//}
//
//func (constraint all) apply(c *logic.C, lm *litMapping, subject Identifier) z.Lit {
//	ms := make([]z.Lit, len(constraint))
//	for i, constr := range constraint {
//		ms[i] = constr.apply(c, lm, subject)
//	}
//
//	if subject == "alpha.v0.1.0" {
//		dep1 := c.Ors(lm.LitOf("alpha.v0.1.0").Not(), lm.LitOf("beta.v0.1.0"), lm.LitOf("beta.v0.2.0"))
//		dep2 := c.Ors(lm.LitOf("alpha.v0.1.0").Not(), lm.LitOf("beta.v0.1.0"), lm.LitOf("beta.v0.3.0"))
//		return c.Ands(dep1, dep2)
//	}
//	fmt.Println("i'm over here")
//	return c.Ands(ms...)
//}
//
//func (constraint all) order() []Identifier {
//	return nil
//}
//
//func (constraint all) anchor() bool {
//	return false
//}
//
...
//type any []Constraint
//
//func (constraint any) String(subject Identifier) string {
//	s := make([]string, len(constraint))
//	for i, each := range constraint {
//		s[i] = each.String(subject)
//	}
...
//}
//
//func (constraint any) apply(c *logic.C, lm *litMapping, subject Identifier) z.Lit {
//	ms := make([]z.Lit, len(constraint))
//	for i, constr := range constraint {
//		ms[i] = constr.apply(c, lm, subject)
//	}
...
//}
//
//func (constraint any) order() []Identifier {
//	return nil
//}
//
//func (constraint any) anchor() bool {
//	return false
//}
//
